    ...
    return (
        <div className="relative bg-green-50 overflow-hidden">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute top-0 right-0 h-full w-1/3 bg-gradient-to-l from-green-200 to-transparent"></div>
                <svg
                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                        <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl sm:leading-tight lg:text-6xl">
                                ...
                                <span className="block text-green-600">renovação na natureza</span>
                            </h1>
                            ...
                            <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                    ...
                                    <div className="mt-3 sm:mt-0 sm:ml-3">
                                        <a
                                            href="#saiba-mais"
                                            className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-green-700 bg-green-100 hover:bg-green-200 md:py-4 md:text-lg md:px-10 transition duration-300"
                                        >
                                            Saiba mais
                                        </a>
                                    </div>
                        ...
                        <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
                            <div className="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md">
                                <div className="relative block w-full bg-white overflow-hidden rounded-lg">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-green-800 to-transparent opacity-70"></div>
                                    <div className="absolute bottom-0 left-0 p-6">
                                        <h3 className="text-xl font-semibold text-white">Retiro de Cura na Floresta</h3>
                                        <p className="mt-1 text-green-100">Próxima data: 15-17 de Outubro</p>
                                    </div>
                                </div>
                            </div>
                        </div>
