...
const BotaoSeta = ({ texto = "Saiba mais" }) => {
  return (
    
    <button className="learn-more relative inline-block w-56 h-12 overflow-hidden p-0 border-none cursor-pointer bg-transparent font-inherit text-inherit">
